  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" href="#collapse1">Cadastrar Novo Coordenador</a>
      </h4>
    </div>
    <div id="collapse1" class="panel-collapse collapse">
      <div class="panel-body">
      		<h1>Cadastra Coordenador</h1><h4>Insira os dados do novo Coordenador</h4>
	<form id="cdt">
		<div class="row">
			<div class="col-lg-12">
				<br>
				...
				<input type="text" hidden id="tipo" value="criaScr">
					<div class="input-group">
						<input type="text" class="form-control" name="edittName" id="xcName" placeholder="Nome completo" required value="">
						<span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
					</div>
				</div>
				<div class="form-group">
					<div class="input-group">
						<input type="text" class="form-control" id="xcCPF" name="scCPF" placeholder="CPF" required value="">
						<span class="input-group-addon"><span class="glyphicon glyphicon-map-marker"></span></span>
					</div>
				</div>
				<div class="form-group">
					<div class="input-group">
						<input type="text" class="form-control" id="xcRg" name="scRg" placeholder="RG" required value="">
						<span class="input-group-addon"><span class="glyphicon glyphicon-map-marker"></span></span>
					</div>
				</div>
				<div class="form-group">
					<div class="input-group">
						<input type="text" class="form-control" id="xcTit" name="scTit" placeholder="Título de eleitor" required value="">
						<span class="input-group-addon"><span class="glyphicon glyphicon-map-marker"></span></span>
					</div>
				</div>
					<div class="form-group">
						<div class="input-group">
							<select class="form-control" name="scSexo" id="xcSexo">
				...
				<div class="form-group">
					<div class="input-group">
						<input type="text" class="form-control" id="xcEnd" name="scEnd" placeholder="Endereço" required value="">
						<span class="input-group-addon"><span class="glyphicon glyphicon-map-marker"></span></span>
					</div>
				</div>
				<div class="form-group">
					<div class="input-group">
						<input type="text" class="form-control" id="xcBair" name="scBair" placeholder="Bairro" required value="">
						<span class="input-group-addon"><span class="glyphicon glyphicon-map-marker"></span></span>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#scSexo').val('null');
		$('#xcdt').submit(function(){
			var tipo = $("#tipo").val();
			var nome = $("#xcName").val();
			var cpf = $("#xcCPF").val();
			var rg = $("#xcRg").val();
			var sexo = $("#xcSexo").val();
			var titulo_eleitor = $("#xcTit").val();
			var endereco = $("#xcEnd").val();
			var bairro = $("#xcBair").val();
			var crd = '0';
		$.ajax({ //Função AJAX
